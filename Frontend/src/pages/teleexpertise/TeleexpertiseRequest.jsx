...
import { ChevronLeft, Users, Search, Check } from "lucide-react";
...
export default function TeleexpertiseRequest() {
  ...
  const { data: specialists } = useQuery({
    ...
    queryFn: () =>
      directoryApi
        .search({ specialty, search: specialistSearch, limit: 10 })
      ...
      <div className="max-w-2xl mx-auto space-y-5 animate-fade-in">
        ...
        >
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Input
                ...
                placeholder="Ex : Interprétation ECG anormal"
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Input
                  label="Âge du patient (optionnel)"
                  placeholder="Ex : 45"
            ...
            <CardContent className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Résumé du cas clinique <span className="text-red-500">*</span>
                </label>
                <textarea
                  rows={5}
                ...
                {errors.clinical_summary && (
                  <p className="text-xs text-red-500 mt-1">
                    {errors.clinical_summary.message}
                  </p>
                )}
              </div>
              <div>
          ...
          {specialty && (
            <Card>
              <CardHeader>
                <h3 className="section-title">Spécialiste (optionnel)</h3>
              </CardHeader>
              <CardContent className="space-y-3">
                <p className="text-xs text-gray-500">
                  Laissez vide pour que la plateforme assigne automatiquement un
                    ...
                    <button
                      ...
                      onClick={() =>
                        setSelectedSpecialist(
                          selectedSpecialist?.id === doc.id ? null : doc,
                        )
                      }
