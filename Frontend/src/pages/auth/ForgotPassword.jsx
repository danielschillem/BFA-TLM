...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(firstError ?? err.response?.data?.message ?? 'Erreur lors de l\'envoi')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          <img src={liptakoIcon} alt="LiptakoCare" className="w-14 h-14 rounded-2xl object-cover shadow-lg mb-4 mx-auto" />
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-xs text-gray-400">Si vous ne recevez pas l'email, vérifiez votre dossier spam.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <Input
                ...
                required
              />
              <Button type="submit" loading={loading} className="w-full" size="lg" icon={Mail}>
                Envoyer le lien
              </Button>
            </form>
          )}
          ...
          <div className="mt-4 text-center">
            ...
            <Link to="/reset-password" className="mt-2 inline-block text-xs text-gray-500 hover:text-primary-600 hover:underline">
