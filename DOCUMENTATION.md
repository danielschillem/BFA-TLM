...
### Phase 1 — Consolidation du MVP *(T2 2026)*
...
### Phase 2 — Téléconsultation avancée *(T3 2026)*
...
### Phase 3 — Gestion financière complète *(T4 2026)*
...
### Phase 4 — Intelligence & Reporting *(T1 2027)*
...
### Phase 5 — Application Mobile *(T2 2027)*
...
### Phase 6 — Interopérabilité *(T3-T4 2027)*
...
### Administration *(auth:api, role:admin)*
| Méthode | Endpoint | Description |
|---------|----------|-------------|
...
### Gestionnaire *(auth:api, role:structure_manager)*
| Méthode | Endpoint | Description |
|---------|----------|-------------|
...
*Document généré le 25 mars 2026 — TLM_APP-BFA v2.0.0*
